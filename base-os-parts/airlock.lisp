      ...
      (
        ...
        (switch-state (state)
          ...
          (case state
            (inner
              ...
              (stationeers::syscall-device-store-async output-closed logic-type:on 0)
              (stationeers::syscall-device-store-async output-inner logic-type:on 1)
              (stationeers::syscall-device-store-async output-outer logic-type:on 0)
              
              (stationeers::syscall-device-store-async input-switches logic-type:open 0)
              (stationeers::syscall-device-store-async input-switches-inverted logic-type:open 1)
              (stationeers::syscall-device-store-async input-switches logic-type:lock 0)
              (stationeers::syscall-device-store-async input-switches-inverted logic-type:lock 0)
              
              (stationeers::syscall-device-store-async inner-door logic-type:mode 0)

              (stationeers::syscall-device-store-async output-progress logic-type:setting 0)
            )
            (outer
              (setq state-atmosphere 'outer)
              (setq state-last-door-change-time *game-time*)
              (stationeers::syscall-device-store-async output-closed logic-type:on 0)
              (stationeers::syscall-device-store-async output-inner logic-type:on 0)
              (stationeers::syscall-device-store-async output-outer logic-type:on 1)
              
              (stationeers::syscall-device-store-async input-switches logic-type:open 1)
              (stationeers::syscall-device-store-async input-switches-inverted logic-type:open 0)
              (stationeers::syscall-device-store-async input-switches logic-type:lock 0)
              (stationeers::syscall-device-store-async input-switches-inverted logic-type:lock 0)
              
              (stationeers::syscall-device-store-async outer-door logic-type:mode 0)
              
              (stationeers::syscall-device-store-async output-progress logic-type:setting 1)
            )
            (closed
              (setq state-atmosphere 'outer)
              (setq state-last-door-change-time *game-time*)
              (stationeers::syscall-device-store-async output-closed logic-type:on 1)
              (stationeers::syscall-device-store-async output-inner logic-type:on 0)
              (stationeers::syscall-device-store-async output-outer logic-type:on 0)
              
              (stationeers::syscall-device-store-async output-progress logic-type:setting 0.5)
            )
            (depressurize-inner
              (stationeers::syscall-device-store-async inner-vent logic-type:mode 1)
              (stationeers::syscall-device-store-async inner-vent logic-type:on 1)
              (stationeers::syscall-device-store-async inner-door logic-type:open 0)
              (stationeers::syscall-device-store-async inner-door logic-type:mode 1)
              (stationeers::syscall-device-store-async output-closed logic-type:on 1)
              (stationeers::syscall-device-store-async output-inner logic-type:on 0)
              (stationeers::syscall-device-store-async output-outer logic-type:on 0)
              ...
              (stationeers::syscall-device-store-async input-switches logic-type:open 1)
              (stationeers::syscall-device-store-async input-switches-inverted logic-type:open 0)
              (stationeers::syscall-device-store-async input-switches logic-type:lock 1)
              (stationeers::syscall-device-store-async input-switches-inverted logic-type:lock 1)
              
              (stationeers::syscall-device-store-async inner-door logic-type:mode 1)
            )
            (depressurize-outer
              (stationeers::syscall-device-store-async outer-vent logic-type:mode 1)
              (stationeers::syscall-device-store-async outer-vent logic-type:on 1)
              (stationeers::syscall-device-store-async outer-door logic-type:open 0)
              (stationeers::syscall-device-store-async outer-door logic-type:mode 1)
              (stationeers::syscall-device-store-async output-closed logic-type:on 1)
              (stationeers::syscall-device-store-async output-inner logic-type:on 0)
              (stationeers::syscall-device-store-async output-outer logic-type:on 0)
            ...
            (pressurize-inner
              (stationeers::syscall-device-store-async inner-vent logic-type:mode 0)
              (stationeers::syscall-device-store-async inner-vent logic-type:on 1)
              (stationeers::syscall-device-store-async outer-vent logic-type:on 0)
              (stationeers::syscall-device-store-async output-closed logic-type:on 1)
              (stationeers::syscall-device-store-async output-inner logic-type:on 0)
              (stationeers::syscall-device-store-async output-outer logic-type:on 0)
            )
            (pressurize-outer
              (stationeers::syscall-device-store-async outer-vent logic-type:mode 0)
              (stationeers::syscall-device-store-async outer-vent logic-type:on 1)
        ...
        (handle-power ()
          (let*
            ...
            (if should-poweroff
              (when state-power
                (stationeers::syscall-device-store-async lamps logic-type:on 0)
                (when (or (eq state-current 'inner) (eq state-current 'outer) (eq state-current 'closed))
                  ...
                  (stationeers::syscall-device-store-async outer-door logic-type:on 0)
                  (stationeers::syscall-device-store-async inner-door logic-type:on 0)
                )
              )
              (when (not state-power)
                ...
                (setq state-power t)
                (stationeers::syscall-device-store-async lamps logic-type:on 1)
                (stationeers::syscall-device-store-async outer-door logic-type:on 1)
                (stationeers::syscall-device-store-async inner-door logic-type:on 1)
              )
            )
            ...
            (if should-lock
              (when (not occupied)
                (unless state-locked
                  ...
                  (stationeers::syscall-device-store-async output-inner logic-type:on 0)
                  (stationeers::syscall-device-store-async output-outer logic-type:on 0)
                  (stationeers::syscall-device-store-async outer-door logic-type:lock 1)
                  (stationeers::syscall-device-store-async inner-door logic-type:lock 1)
              ...
              (when state-locked
                ...
                (stationeers::syscall-device-store-async outer-door logic-type:lock 0)
                (stationeers::syscall-device-store-async inner-door logic-type:lock 0)
                (stationeers::syscall-device-store-async outer-door logic-type:mode 1)
                (stationeers::syscall-device-store-async inner-door logic-type:mode 1)
        ...
        (handle-state-unknown ()
          ...
          (let
            ...
            (stationeers::syscall-device-store-async outer-door logic-type:mode 1)
            (stationeers::syscall-device-store-async inner-door logic-type:mode 1)
            (stationeers::syscall-device-store-async outer-vent logic-type:lock 1)
            (stationeers::syscall-device-store-async inner-vent logic-type:lock 1)
            (stationeers::syscall-device-store-async outer-vent logic-type:on 0)
            (stationeers::syscall-device-store-async inner-vent logic-type:on 0)
            (stationeers::syscall-device-store-async lamps logic-type:on 1)
          ...
          (let*
            ...
            (when inner-pressed
              (if (eq state-atmosphere 'inner)
                (progn
                  (stationeers::syscall-device-store-async inner-door logic-type:open 1)
                  (switch-state 'inner)
                )
                (switch-state 'depressurize-outer)
              )
            ...
            (when outer-pressed
              (if (eq state-atmosphere 'inner)
                (switch-state 'depressurize-inner)
                (progn
                  (stationeers::syscall-device-store-async outer-door logic-type:open 1)
                  (switch-state 'outer)
                )
              )
            )
          ...
          (let*
            ...
            (when (= 0 pressure)
              (if (< forceclose-sum 0.5)
                ...
                (switch-state 'break-room)
              )
            )
          )
        )
        (handle-state-break-room ()
          (let*
            (
              (forceclose-switches (await-all fetched-inputs-forceclose))
              (forceclose-sum (apply #'+ (loop for x in forceclose-switches when x collect x)))
            )
            (when (< forceclose-sum 0.5)
              (switch-state 'pressurize-outer)
            )
          )
        )
      ...
      (funcall update (lambda ()
        ...
        (if state-power
          (case state-current
            ...
            (break-room (handle-state-break-room))
